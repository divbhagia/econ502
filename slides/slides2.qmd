...
$$CS = \int_{p_0}^{p_1} x(p, p_y, I) \, dp$$

::: {.fragment}
**Advantages:**

- Easy to estimate from market data
- Don't need to know utility function
- Widely used in applied work

**Disadvantages:**

- Only an approximation (not exact welfare measure)
- Mixes income and substitution effects
- Can differ substantially from CV and EV for large changes
:::
