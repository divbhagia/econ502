...
![](input/slides4-ls-cons-cost.png){width=80% fig-align="center"}
...
![](input/slides4-ls-inc-cost.png){width=80% fig-align="center"}
...
:::: {.columns}
::: {.column width=50%}
![](input/slides4-cs-ps.png){width=100%}

**Total surplus** (CS + PS) is maximized at the competitive equilibrium.
:::
::: {.column width=50%}
![](input/slides4-dwl.png){width=100%}
